...
public class Status : MonoBehaviour
{
    ...
    void Awake()
    {
        ...
        currentNourishment = maxNourishment.GetValue() * 0.75554f;
        currentWater = maxWater.GetValue() * 0.75554f;
    ...
    public void IncreaseNourishment(float amount)
    {
        ...
        if (currentNourishment < 0)
        {
            ...
            maxStamina.RemoveModifier(starvingStaminaDetriment);
        ...
        UpdateHungerBonusesAndDetriments();
    ...
    void UpdateHungerBonusesAndDetriments()
    {
        ...
        if (currentNourishment >= 30f && currentNourishment < 45f && currentHungerLevel != HungerLevel.Peckish)
            AddHungerStaminaDetriment(0.1f);
    ...
    void AddHungerStaminaDetriment(float staminaDrainMultiplier)
    {
        ...
        starvingStaminaDetriment = Mathf.RoundToInt(maxStamina.GetBaseValue() * -staminaDrainMultiplier);

        maxStamina.AddModifier(starvingStaminaDetriment);
    ...
    public void IncreaseWater(float amount)
    {
        ...
        {
            currentWater = 0;
            maxStamina.RemoveModifier(dehydratedStaminaDetriment);
    ...
    public void DrainThirst(int timePassed = 6)
    {
        ...
        if (currentWater < 0)
        {
            ...
            dehydratedStaminaDetriment = Mathf.RoundToInt(maxStamina.GetBaseValue() * -0.35f);
            maxStamina.AddModifier(dehydratedStaminaDetriment);
            if (currentStamina > maxStamina.GetValue())
                currentStamina = maxStamina.GetValue();
        }
